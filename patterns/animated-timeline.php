 ...
 */
return array(
	'title'      => __( 'Animated Timeline', 'animated-timeline' ),
	'categories' => array( 'about', 'columns', 'team' ),
	'source'     => 'plugin',
	'content'    => '<!-- wp:group {"tagName":"section","style":{"spacing":{"blockGap":"0","padding":{"top":"0","right":"0","bottom":"0","left":"0"},"margin":{"top":"36px","bottom":"36px"}}},"className":"animated-timeline","layout":{"type":"default"}} -->
...
<figure class="wp-block-image size-full is-resized"><img src="' . esc_url( plugins_url( 'assets/images/WP-6.5-Regina.png', dirname( __FILE__ ) ) ) . '" alt="" style="aspect-ratio:4/3;object-fit:contain;width:500px"/></figure>
<!-- /wp:image --></div>
<!-- /wp:column --></div>
<!-- /wp:columns -->
...
<!-- wp:image {"width":"500px","aspectRatio":"4/3","scale":"contain","sizeSlug":"full","linkDestination":"none","style":{"color":{"duotone":"var:preset|duotone|duotone-1"}}} -->
<figure class="wp-block-image size-full is-resized"><img src="' . esc_url( plugins_url( 'assets/images/WP-6.4-Shirley.png', dirname( __FILE__ ) ) ) . '" alt="" style="aspect-ratio:4/3;object-fit:contain;width:500px"/></figure>
<!-- /wp:image --></div>
<!-- /wp:column --></div>
<!-- /wp:columns -->
...
<!-- wp:image {"width":"500px","aspectRatio":"4/3","scale":"contain","sizeSlug":"full","linkDestination":"none","style":{"color":{"duotone":"var:preset|duotone|duotone-1"}}} -->
<figure class="wp-block-image size-full is-resized"><img src="' . esc_url( plugins_url( 'assets/images/WP-6.3-Lionel.png', dirname( __FILE__ ) ) ) . '" alt="" style="aspect-ratio:4/3;object-fit:contain;width:500px"/></figure>
<!-- /wp:image --></div>
<!-- /wp:column --></div>
<!-- /wp:columns --></section>
<!-- /wp:group -->',
